...
pub const MEM_NOTIFY_RX: u32 =
	ConfigAddress::from_configuration_address(NOTIFY_REGION_START as u32).0;
pub const MEM_NOTIFY_TX: u32 = ConfigAddress::from_configuration_address(
